...
from utils.preprocess import carla_seg_to_array, carla_rgb_to_array,  road_option_to_int, int_to_road_option, read_routes, read_routes_instructions, traffic_light_to_int
from utils.test_utils import model_control, calculate_distance, DistanceTracker, calculate_delta_yaw
from utils.high_level_command_instructions import HighLevelCommandLoader
...
def main(params):
    ...
    episode_configs = read_routes_instructions(params.episode_file)
    ...
    for i in range(params.n_episodes):
        ...
        hlc_loader.initialize_model(params.bert_model_path, params.tokenizer_name, params.label_mapping_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bert_model_path', type=str, required=True, help="Path to the trained model directory.")
